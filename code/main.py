...
def recur(input_dir, node_dir, n_cluster, parent, n_cluster_iter, filter_thre, n_expand, level, caseolap=True):
    if level >= 3:
        return
...
def main(opt):
    ...
    recur(input_dir, root_dir, n_cluster, '*', n_cluster_iter, filter_thre, n_expand, level, False)
