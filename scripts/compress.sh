...
python ../code/compress.py -root ../data/dblp/our-l3-0.4-c10 -output ../data/dblp/taxonomies/l3-our-0.4-c10.txt
python ../code/compress.py -root ../data/dblp/our-l4-0.25 -output ../data/dblp/taxonomies/l4-our-0.25.txt
python ../code/compress.py -root ../data/dblp/our-l4-0.4 -output ../data/dblp/taxonomies/l4-our-0.4.txt
...
python ../code/compress.py -root ../data/dblp/ablation-no-local-embedding-l3-0.4-c10 -output ../data/dblp/taxonomies/l3-ablation-no-local-embedding-0.4-c10.txt
...
python ../code/compress.py -root ../data/dblp/ablation-no-local-embedding-l4-0.4 -output ../data/dblp/taxonomies/l4-ablation-no-local-embedding-0.4.txt
